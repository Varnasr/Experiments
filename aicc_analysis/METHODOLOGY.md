...
- 17 mobile numbers shared by >1 candidate; most are typo-pairs (`G.TIKARAM` vs `G.Tikaram`, `B.Muralidhar` vs `B .Muralidhar`). One suspicious case: mobile `8143447555` shared by `Koka Phani Bhushan` and `Nallabrollu Kumari`.
